...
conda activate ra_env  # <-- Replace with your conda env name

# python main.py --mode train --data chest --model csflow

# python main.py --mode test --data chest --model csflow --weight ./csflow/checkpoint/chest_0717v2/best.pth

# python resnet_chest.py
python resnet_mammo.py
