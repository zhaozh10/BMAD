...
# python main.py --mode train --data chest --model csflow

# python main.py --mode test --data chest --model csflow --weight ./csflow/checkpoint/chest_0723/best.pth

python main.py --mode train --data mammo --model csflow

python main.py --mode test --data mammo --model csflow --weight ./csflow/checkpoint/mammo_0723_mass/best.pth
